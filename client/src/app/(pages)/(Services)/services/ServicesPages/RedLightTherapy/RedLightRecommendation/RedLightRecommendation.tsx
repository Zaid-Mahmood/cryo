            ...
            >
                ...
                >
                       {reviews.map((item, i) => (
                        ...
                        <div
                            key={i}
                            className="relative aspect-[4/3] min-w-[85%] md:min-w-[32%] rounded-2xl bg-white shadow-[0px_4px_10px_#0000000F]"
                        >
                            <Image
                                src={item.image}
                                alt="article-img"
                            ...
                            <Link className="pt-4 inline-flex items-center gap-2 text-[var(--btn-bg-primary)] font-medium font-body text-base" href={item.link.href}>{item.link.text}
                                <Image
                                    src={item.link.arrow}
                                    alt="arrow"
                                    width={16}
...
export default RedLightRecommendation
