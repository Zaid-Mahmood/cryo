...
import Img3 from "@/assets/service-drop/iv-infusion/packages.png";
import Img2 from "@/assets/service-drop/iv-infusion/packages.png";
import Img1 from "@/assets/service-drop/iv-infusion/packages.png";
import Image from "next/image";
import Link from "next/link";
const IVInfusionPackages = () => {
      const reviews = [
        {
            cardHeading: "Essential Hydration IV",
            cardDescription:
        ...
        {
            cardHeading: "Vitamin C Nutrient IV",
            cardDescription:
                "Reduce inflammation, speed up recovery, and support muscle repair with advanced cold therapy.",
            price: "229",
            // seeion: 5,
...
export default IVInfusionPackages
