...
const CommonBanner = ({
  ...
  return (
    <section className={`relative w-full overflow-hidden ${height}`}>
      ...
      {/* Content */}
      <div
        className={`relative z-10 flex h-full px-6 lg:px-16 ${
          isLeft
                ...
                <Link
                  ...
                  onClick={(e) => {
                    if (button.href.startsWith("#")) {
                      ...
                      const section = document.querySelector(button.href);
                  ...
                  className={`flex justify-between items-center gap-2 rounded-full px-6 py-3 font-semibold transition text-base font-body ${
