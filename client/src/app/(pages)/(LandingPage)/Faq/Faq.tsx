"use client"
import CommonForm from "../../(CommonPages)/CommonForm/CommonForm";
import CommonAccordion from "../../(CommonPages)/CommonAccordion/CommonAcordion";
const Faq = () => {
    const formData = [
    ...
    return (
        <div className="px-5 pb-8 md:px-16 md:pb-13">
            ...
            <div className="grid md:grid-cols-2  gap-x-11 md:place-items-center">
